...
module.exports = createTreeWriteStream

function createTreeWriteStream (db, opts) {
  if (!opts) opts = {}
...
var ws = createTreeWriteStream(db, {index: true, rabin: true})

var b = require('fs').readFileSync(__filename)
ws.write(b)
ws.write(b)
ws.write(b)
ws.write(b)
